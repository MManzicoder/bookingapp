...
<div class="container_fluid d-flex ">
    ...
    <div class="m-5 w-50">
    <form action="<?= base_url('index.php/hotelController/add_hotel') ?>" method="post" class="form">
    <h3 class="card-title">Hotel Registration</h3>
    <div class="mb-3">
    ...
    <input type="submit" value="Submit" class="btn btn-primary mb-5" name="submit">
    </form>
    </div>
</body>
</html>