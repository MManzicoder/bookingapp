...
<body>
    ...
    <div class="row">
     ...
     <div class="col-sm-4">
     <a href="<?php echo base_url('index.php/Provinces/index')?>" class="btn btn-info add-new" type="button"><i class="fa fa-plus"></i>Add New</a>
     </div>
    </div>
    </div>
    <?php
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <a class="edit" title="Edit" data-toggle="tooltip" href='updatehotel?hId=<?=$row->hId?>'?><i class="material-icons">&#xE254;</i></a>
                    <a class="delete" title="Delete" data-toggle="tooltip" href='deletedata?id=<?=$row->hId?>'><i class="material-icons">&#xE872;</i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
